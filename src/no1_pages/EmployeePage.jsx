...
import { remove } from '../no3_store/slices/employSlice'
...
const EmployeePage = () => {
  ...
  return (
    <div>
      ...
      <EmployeeTable/>
      <div>
        <button onClick={() => dispatch(setMode("addEmp"))}>등록</button>
        <button onClick={() => dispatch(setMode("update"))}>수정</button>
        <button onClick={() => dispatch(setMode("remove"))}>삭제</button>
      </div>
      {
